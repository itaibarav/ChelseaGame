...
export function shopView(){
  return hud()+`<div class="head"><h1>חנות המעטפות</h1><p>כל מעטפה מכילה 5 מדבקות</p></div>
    ...
    <p class="note">מעטפת זהב משריינת סלוט אקראי אחד מתוך 5 לקלף נדיר, ואותה מדבקה לא תצא פעמיים באותה מעטפה.<br>מיחזור כפילות שווה מטבע אחד. העותק האחרון של כל מדבקה נשמר תמיד.</p>`;
}
