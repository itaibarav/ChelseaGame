...
the player play stamford run with 4 different kits | שחק במשחק ריצת סטמפורד עם 4 תלבושות שונות | 80
...
the player score 150 goals in penalties battle game | הבקע 150 שערים בדו-קרב פנדלים | 150
the player score 200 goals in penalties battle game | הבקע 200 שערים בדו-קרב פנדלים | 200
the player win 20 times rock-sciessor-paper game | נצח את פאלמר 20 פעמים באבן נייר ומספריים | 30
the player win 40 times rock-sciessor-paper game | נצח את פאלמר 40 פעמים באבן נייר ומספריים | 60
the player win 60 times rock-sciessor-paper game | נצח את פאלמר 60 פעמים באבן נייר ומספריים | 90
the player win 10 times in memory game | נצח 10 פעמים במשחק הזכרון | 25
the player win 20 times in memory game | נצח 20 פעמים במשחק הזכרון | 50
the player win 35 times in memory game | נצח 35 פעמים במשחק הזכרון | 100
the player win 10 times in X/O games | נצח 10 פעמים באיקס עיגול | 25
the player win 20 times in X/O games | נצח 20 פעמים באיקס עיגול | 50
...
the player purchase 10 kits in the locker | רכוש 12 מדים לאווטאר שלך | 75
the player purchase 10 kits in the locker | רכוש 15 מדים לאווטאר שלך | 200
the player purchase 2 hats in the locker | רכוש  2 כובעים לאווטר שלך | 30
...
the player purchase all scarfs in the locker | רכוש את כל הצעיפים לאווטאר שלך | 100
the player purchase 2 shoes in the locker | רכוש 2 נעליים לאווטאר שלך | 50
the player purchase all shoes in the locker | רכוש את כל הנעליים לאווטאר שלך | 100
...
the player complete the full logos (chelsea badges) page in the album | השלם את מדבקות כל הסמלים באלבום | 50
the player complete the full skills page in the album | השלם את מדבקות כל הסקילים באלבום | 50
...
the player purchase 400 packs | קנה 400 מעטפות בחנות | 400
the player purchase 15 Legend packs | קנה 15 מעטפות אגדה בחנות | 100
the player purchase 30 Legend packs | קנה 30 מעטפות אגדה בחנות | 150
the player purchase 15 Kits packs | קנה 15 מעטפות מדים בחנות | 100
the player purchase 30 Kits packs | קנה 30 מעטפות מדים בחנות | 150
...
the player watch the table | צפה בטבלת הליגה | 20
the player mark 20 news as 'read' | סמן 'קראתי' על 20 חדשות | 80
the player mark 40 news as 'read' | סמן 'קראתי' על 40 חדשות | 120
the player mark 100 news as 'read' | סמן 'קראתי' על 100 חדשות | 210
...
the player watched 5 different legends videos | צפה ב-5 סרטוני הייליטס של אגדות | 100
the player watched cup winning video | צפה בסרטון של זכייה בגביע | 50
the player watched 3 different cup winning videos | צפה ב-3 סרטונים של זכייה בגביע | 100
...
the player purchase all the balls in the locker | קנה את כל הכדורים בחנות | 100
